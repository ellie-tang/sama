...
public class Template_Widget extends AppWidgetProvider {
     ...
     * Currently returns false because BladeSampleApplication.isLightMode() is overridden to disable
     * dynamic theme switching.
     * @param context Used to get the main Application Type and have access to the DynamicThemeApplication
     *                functions
     * @return It will return True if its in LightMode (currently always false due to override)
     */
